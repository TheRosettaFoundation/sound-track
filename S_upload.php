...
echo '<h2>Solas Soundtrack L10N Component - Processing file selected manually</h2><br>';
...
if($ext == '.htm') {
	//Check HTM file
	$results = checkS_HTM($fileContent, $locale);
...
//create a new file in c:\uploads\... with the name 'S_Results_'.filename
	$fp      = fopen($upload_path.$locale.'_'.$filename, 'w'); //open this local c:\uploads\... file
